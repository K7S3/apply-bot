...
Modules:
    ...
    crashlog  local crash log (redacted records, last-crash marker)
    redact    PII redaction for crash text and diagnostics
    bugreport redacted bug-report builder with opt-in sharing consent
