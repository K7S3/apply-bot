...
Modules:
    ...
    migrate   config.yaml schema upgrades (versioned migrations)
    migrations  the (from_version, to_version, fn) migration registry
    doctor    health checks: config, data dir, Python version
