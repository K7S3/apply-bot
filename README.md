...
| `design` | Designer track: portfolio-review prep packs (honestly labeled general prep), portfolio gap analysis vs any JD, 8 design-method deep-dives, self-critique checklist, interactive design-critique drills with rubric scoring, timed whiteboard exercises, tradeoff rapid-fire, portfolio presentation timer, case-study structuring wizard, portfolio-site content drafts, "walk me through your portfolio" scripts, and case-study Markdown/HTML export. |
