...
| `vesting` | Vesting schedule visualizer: per-grant timelines with cliff markers, cumulative vested-value ASCII charts, refresher-grant stacking, vesting-basis offer comparison (12/24/36/48 mo), leave-at-month-N departure analysis, bear/base/bull $/share scenarios, golden-handcuffs (unvested-remaining) curve, taxable-event markers, and markdown report export. See [docs/vesting.md](docs/vesting.md). |
