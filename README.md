...
| `postaccept` | Post-accept milestone tracker: record the signed offer, vesting-cliff countdown, full vesting calendar (initial grant + refresher grants), 30/60/90-day and 6/12-month first-year milestones, 6/9/12-month promotion check-ins, one sorted reminders list, tenure counter, vested-vs-unvested comp at a share price, and a one-screen dashboard. |
