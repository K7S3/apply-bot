...
| `sre` | DevOps/SRE interview track: verified SRE question bank (Linux, networking, Kubernetes, CI/CD, observability, reliability), reliability concept deep-dives, timed incident-response drills, a war-room simulator (scripted offline, optional AI commander), troubleshooting playbooks, blameless postmortem writer, IaC misconfiguration review drills, on-call STAR story builder, kubectl/Prometheus/Grafana/Linux/Terraform cheatsheets + quizzes, and an SRE career ladder guide. |
