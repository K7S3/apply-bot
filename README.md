...
| `docs` | Offline docs: browse the bundled documentation from your terminal and export it as one plain-text bundle (`docs export-txt`) or one self-contained HTML file (`docs export-html`, no network needed). |
