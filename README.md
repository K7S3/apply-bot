...
| `narrative` | Career story builder: past/present/future narrative arc with source citations, "tell me about yourself" pitches in 30s / 2min / 5min lengths, **sentence-by-sentence approval** (nothing becomes canonical until you approve every word), per-role JD tailoring (drafts never auto-approved), opening-line hook library, role-transition bridges, "why us / why this role" paragraphs (company facts come only from you), a 140-wpm timing coach with pacing tips, failure-story scaffolds from your debriefs, and a one-page interview-prep export. Everything is template-generated from your profile; unknowns become `[fill in: ...]` placeholders, never invented facts. |
